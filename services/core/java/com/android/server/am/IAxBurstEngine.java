...
public interface IAxBurstEngine {
    ...
    default void onEarlyWakeup(boolean start, long maxDurMs) {}

    default void onActivityTransition(String fromPkg, String toPkg, int phase) {}

    default void onActivityExit(String pkg) {}

    default void onProcessKill(int pid, String pkg) {}

    default void setTopAppRenderThread(int pid, int tid) {}

    default void setTopAppPid(int pid) {}

    default void setThermalState(int level, int cpuCap, int gpuCap) {}

    default long acquireResources(long durMs, String[] resNames, long[] values) {
        return 0L;
    }

    default void releaseResources(long handle) {}

    default long swapResources(long prevHandle, long durMs, String[] resNames, long[] values) {
        return 0L;
    }

    default long acquireHint(String hintName, long durOverrideMs) {
        return 0L;
    }

    default long swapHint(long prevHandle, String hintName, long durOverrideMs) {
        return 0L;
    }
}
