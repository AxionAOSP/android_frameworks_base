...
abstract class BitmapDigitLargeClockView @JvmOverloads constructor(
    ...
    override fun drawClock(canvas: Canvas) {
        ...
        val totalHeight = digitHeight * 2 + lineSpacing
        val startY = height / 2f - totalHeight + yOffset
        ...
        clockBottomY = startY + totalHeight
    }
    
    protected open val yOffset: Float get() = context.resources.displayMetrics.density * 72f
