...
public class SystemUIBoostFramework {
    ...
    public static int REQUEST_ANIMATION_BOOST_TYPE_TRACKING_NOTIFICATION_STACK_SCROLL_LAYOUT = 1 << 3;
    public static int REQUEST_ANIMATION_BOOST_TYPE_SPEED_UP_QS_EXPANSION_ANIMATION = 1 << 4;
    public static int REQUEST_ANIMATION_BOOST_TYPE_SPEED_UP_UDFPS_SCAN_ANIMATION = 1 << 5;
