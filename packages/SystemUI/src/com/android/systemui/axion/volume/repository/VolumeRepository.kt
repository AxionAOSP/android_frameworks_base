...
class AxionVolumeRepositoryImpl @Inject constructor(
    ...
    override val availableStreamsFlow: Flow<List<Int>> = combine(
        ...
        getAvailableStreams(state, connectedDevices.isNotEmpty())
    }
    .distinctUntilChanged()
    .flowOn(backgroundDispatcher)
    ...
    private fun getAvailableStreams(state: VolumeDialogController.State, isBluetoothConnected: Boolean): List<Int> {
