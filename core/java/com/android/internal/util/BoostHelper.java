...
public class BoostHelper {
    ...
    public static void onScrollEvent(int action) {
        markHot();
        try {
            ActivityManager.getService().onScrollEvent(action);
        } catch (Exception e) {
            logException("onScrollEvent", e);
        }
    }
    ...
    public static void onLaunch(int type) {
        markHot();
        try {
            ActivityManager.getService().onLaunch(type);
        } catch (Exception e) {
            logException("onLaunch", e);
        }
    }
    ...
    public static void onFrameStage(int stage, long frameId) {
        ...
        try {
            ActivityManager.getService().onFrameStage(stage, frameId);
        } catch (Exception e) {
            logException("onFrameStage", e);
        }
    }
    ...
    public static void onRefreshRateEvent(int event) {
        markHot();
        try {
            ActivityManager.getService().onRefreshRateEvent(event);
        } catch (Exception e) {
            logException("onRefreshRateEvent", e);
        }
    }
    ...
    public static void onImeTransition(int action) {
        markHot();
        try {
            ActivityManager.getService().onImeTransition(action);
        } catch (Exception e) {
            logException("onImeTransition", e);
        }
    }
    ...
    public static void onConsistency(int mode) {
        ...
        try {
            ActivityManager.getService().onConsistency(mode);
        } catch (Exception e) {
            logException("onConsistency", e);
        }
    }
    ...
    public static void onAnimation(int action) {
        markHot();
        try {
            ActivityManager.getService().onAnimation(action);
        } catch (Exception e) {
            logException("onAnimation", e);
        }
    }

    public static void onEarlyWakeup(boolean start, long maxDurMs) {
        markHot();
        try {
            ActivityManager.getService().onEarlyWakeup(start, maxDurMs);
        } catch (Exception e) {
            logException("onEarlyWakeup", e);
        }
    }

    public static void onActivityTransition(String fromPkg, String toPkg, int phase) {
        markHot();
        try {
            ActivityManager.getService().onActivityTransition(fromPkg, toPkg, phase);
        } catch (Exception e) {
            logException("onActivityTransition", e);
        }
    }

    public static void onActivityExit(String pkg) {
        markHot();
        try {
            ActivityManager.getService().onActivityExit(pkg);
        } catch (Exception e) {
            logException("onActivityExit", e);
        }
    }

    public static void onProcessKill(int pid, String pkg) {
        try {
            ActivityManager.getService().onProcessKill(pid, pkg);
        } catch (Exception e) {
            logException("onProcessKill", e);
        }
    }

    public static void setTopAppRenderThread(int pid, int tid) {
        try {
            ActivityManager.getService().setTopAppRenderThread(pid, tid);
        } catch (Exception e) {
            logException("setTopAppRenderThread", e);
        }
    }

    public static void setTopAppPid(int pid) {
        try {
            ActivityManager.getService().setTopAppPid(pid);
        } catch (Exception e) {
            logException("setTopAppPid", e);
        }
    }

    public static long acquireResources(long durMs, String[] resNames, long[] values) {
        try {
            return ActivityManager.getService().acquireResources(durMs, resNames, values);
        } catch (Exception e) {
            logException("acquireResources", e);
            return 0L;
        }
    }

    public static void releaseResources(long handle) {
        try {
            ActivityManager.getService().releaseResources(handle);
        } catch (Exception e) {
            logException("releaseResources", e);
        }
    }

    public static long swapResources(
            long prevHandle, long durMs, String[] resNames, long[] values) {
        try {
            return ActivityManager.getService().swapResources(prevHandle, durMs, resNames, values);
        } catch (Exception e) {
            logException("swapResources", e);
            return 0L;
        }
    }

    public static long acquireHint(String hintName, long durOverrideMs) {
        try {
            return ActivityManager.getService().acquireHint(hintName, durOverrideMs);
        } catch (Exception e) {
            logException("acquireHint", e);
            return 0L;
        }
    }

    public static long swapHint(long prevHandle, String hintName, long durOverrideMs) {
        try {
            return ActivityManager.getService().swapHint(prevHandle, hintName, durOverrideMs);
        } catch (Exception e) {
            logException("swapHint", e);
            return 0L;
        }
    }
